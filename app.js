...
function winGame(){
  ...
  $("#message").html('<div id="you-won" class="alert alert-success" role="alert"><strong>:D</strong> Congradulations you won! You can start a new game. The number was <span style="{font-size=40}">'+randomNumber+'</span></div>');
